        ...
        <div className="bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  border-gray-600 rounded-md shadow-sm placeholder-gray-400 focus:outline-none
            ...
            <button
              ...
              hover:bg-emerald-700 focus: outline-none focus:ring-offset-2 
            ...
            >
              {loading ? (
                <>
                  <Loader
                    className="mr-2h-5-w5 animate-spin"
                    aria-hidden="true"
                  />
                  Loading...
                </>
